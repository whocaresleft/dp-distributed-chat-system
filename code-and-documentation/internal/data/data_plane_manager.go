...
type DataPlaneManager struct {
	...
	connMan         network.ConnectionManager               // Component that handles the network communication with other data plane nodes
...
func NewDataPlaneManager(c network.ConnectionManager) *DataPlaneManager {
